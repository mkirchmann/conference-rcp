...
public class AbstractTreeModel<ParentType, SelfType, ChildrenType> extends
		AbstractDelegatingModel<SelfType> {
	Collection<ChildrenType> children;
	private final ParentType parent;

	public AbstractTreeModel(final ParentType parent, final SelfType delegate,
			final List<ChildrenType> children) {
		super(delegate);
		this.parent = parent;
